...
- **v3.10.0 — 全局計時器** ✅ 完成（2026-05-01；今日總工時儀表板留之後迭代）
- **v3.11.0 — 個人達成率 + 預測** ✅ 完成（2026-05-01）
- **v3.12.0 — 請款單歷史** ✅ 完成（2026-05-01）
- **v3.13.0 — 看板模式 + 拖曳改狀態** ✅ 完成（2026-05-01；inline edit / 手機手勢留之後）
- **v3.14.0 — 標籤系統升級** ✅ 完成（2026-05-01；業主+案件 multi-tag；統計分頁 / 業主 filter / 顏色留 v3.14.1）
- **v3.15.0 — 撤銷系統 (Undo)** ✅ 完成（2026-05-01）
